...
public class ReboarDispatcher extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			fin = new FileInputStream("C:\\Users\\hong\\eclipse-workspace-jsp\\uniPro\\src\\dispatcher\\ReboarDispatcher.properties");
			prop.load(fin);
		} catch (Exception e) {
		...
		while( iter.hasNext() ) { 
			...
			try {
				...
				reboardSuper father=(reboardSuper)c.newInstance();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reboardSuper father = (reboardSuper)map.get(path);
		System.out.println("ReboardSuper father ="+father);
