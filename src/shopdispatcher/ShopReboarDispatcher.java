...
public class ShopReboarDispatcher extends HttpServlet {
	...
	private HashMap<String, ShopreboardSuper> map = new HashMap<String, ShopreboardSuper>(); //컨트롤러가 저장
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			fin = new FileInputStream("D:\\teamproject\\uniPro\\src\\shopdispatcher\\ShopreboarDispatcher.properties");
			prop.load(fin);
		} catch (Exception e) {
