...
function page_move(s_page){
    ...
    f.action="sub.ho?oriNo=${temp.b_id}";//이동할 페이지
...
<form name="paging">
  ...
  <section class="page-section portfolio" id="portfolio">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">인기매물</h2>
      ...
      <div class="row">
        ...
        <c:forEach var="temp" items="${list}" begin="0" end="0" >
       	 <a class ="portfolio-item mx-auto" href="javascript:page_move(1)">
      ...
      <h3 class="card-title">필립스 32인치 모니터/TV 가져가세요</h3>
