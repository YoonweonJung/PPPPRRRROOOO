...
<%--  request.setAttribute("REBOARD", vo);      //원글상세내용
 ...
 REBOARD=${REBOARD}<br/>
 nowPage=${nowPage}<br/>
	<form method="POST" action="../reboard/modifyProc.bo" id="mfrm">
	  ...
	  <input type="hidden" name="nowPage" value="${nowPage}" />
		<table width="600" border="1" align="center">
			<tr>
				<td>제목</td>
				<td><input type="text" name="title" id="title" value="${REBOARD.title}"/></td>
			</tr>
			<tr>
				<td>본문</td>
				<td><textarea name="body" id="body">${REBOARD.body}</textarea></td>
			</tr>
			<tr>
				<td>비밀번호</td>
